...
class Level12 extends Component{
    constructor() {
        ...
        this.state={
            count:1,
            text:'​ขอต่ออายุใบอนุญาต',
            data:[
                {
                    id: '31',
                    name: '​ขอต่ออายุใบอนุญาต',
                    state: '3',
                    link: '',
                    group: 'อาหาร',
                },
                            ...
                            <Grid.Column>
                                <Card fluid>
                                    <Card.Content>
                                        ...
                                        <Card.Description>
                                            <p>
                                                อาหาร > สถานที่ > ใบอนุญาตสถานที่ผลิตอาหาร กรณีเข้าข่ายโรงงาน (คนงาน ≥ 50 คน หรือ เครื่องจักร ≥ 50 แรงม้า) > ขอต่ออายุใบอนุญาต
                                            </p>
                                            <p>

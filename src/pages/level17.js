...
class Level17 extends Component{
    constructor() {
        super();
        this.state={
            count:1,
            text:'ขอยกเลิกใบอนุญาต',
            data:[
                {
                    id: '36',
                    name: '​ขอยกเลิกใบอนุญาต',
                    state: '3',
                    link: '',
                    group: 'อาหาร',
                },
                            ...
                            <Grid.Column>
                                <Card fluid>
                                    <Card.Content>
                                        ...
                                        <Card.Description>
                                            <p>
                                                อาหาร > สถานที่ > ใบอนุญาตสถานที่ผลิตอาหาร กรณีไม่เข้าข่ายโรงงาน (คนงาน ≥ 50 คน หรือ เครื่องจักร ≥ 50 แรงม้า) > ขอยกเลิกใบอนุญาต
                                            </p>
                                            <p>

...
class Level28 extends Component{
    constructor() {
        super();
        this.state={
            count:2,
            data:[
                ...
                {
                    id: '35',
                    name: 'หนังสือรับรองมาตรฐานสถานที่ผลิตยาในต่างประเทศ ฯ',
                    state: '1',
                    link: '35',
                    group: 'ยา',
                },
            ...
            list.push(
                {
                    ...
                    state: key.state,
                    group: key.group,
                    link: '/level1/' +'หนังสือรับรองมาตรฐานสถานที่ผลิตยาในต่างประเทศ ฯ'+'/drill/' +key.id,
                }
            )
        ))
        return (
                            ...
                            <Grid.Column>
                                <Card fluid>
                                    <Card.Content>
                                        ...
                                        <Card.Description>
                                            <p>
                                                ยา > หนังสือรับรองมาตรฐานสถานที่ผลิตยาในต่างประเทศ ฯ
                                            </p>
                                            <p>

...
class Level7 extends Component{
    constructor() {
        ...
        this.state={
            count:1,
            text:'ใบอนุญาตสถานที่ผลิตอาหาร กรณีเข้าข่ายโรงงาน (คนงาน ≥ 50 คน หรือ เครื่องจักร ≥ 50 แรงม้า)',
            data:[
                {
                    id: '40',
                    name: 'ใบอนุญาตสถานที่ผลิตอาหาร กรณีเข้าข่ายโรงงาน (คนงาน ≥ 50 คน หรือ เครื่องจักร ≥ 50 แรงม้า)',
                    state: '2',
                    link: '',
                    group: 'อาหาร',
                },
                            ...
                            <Grid.Column>
                                <Card fluid>
                                    <Card.Content>
                                        ...
                                        <Card.Description>
                                            <p>
                                                อาหาร > สถานที่ > ใบอนุญาตสถานที่ผลิตอาหาร กรณีเข้าข่ายโรงงาน (คนงาน ≥ 50 คน หรือ เครื่องจักร ≥ 50 แรงม้า)
                                            </p>
                                            <p>
